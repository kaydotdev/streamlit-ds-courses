...
from .common import REQUEST_TIMEOUT, safe_query_attribute, safe_query_text
...
while not requests_queue.empty():
    ...
    dataframe = df.append(record, ignore_index=True)

df.to_json("alison.json", orient="records")
driver.close()
